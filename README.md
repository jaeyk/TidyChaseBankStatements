...
File an [issue](https://github.com/jaeyk/tidy_chase_bank_statements/issues) if you have problems, questions or suggestions.
...
devtools::install_github("jaeyk/tidy_chase_bank_statements",
                         dependencies = TRUE)
```
